...
class HomeViewModel @Inject constructor(private val repository: Repository) : ViewModel() {
    ...
    private suspend fun insertExperiencesInDb(data: ExperiencesResponse){
        val list = data.experiences.map {
            ExperienceTable(
                id = it.id,
                title = it.title,
        ...
        repository.insertAllExperiences(list)
    }
